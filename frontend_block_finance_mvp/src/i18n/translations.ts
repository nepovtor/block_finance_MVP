...
export const translations: Record<Language, TranslationDictionary> = {
  "en": {
    ...
    "auth.passwordPlaceholder": "At least 8 characters, letters and numbers",
    ...
    "auth.nameInvalid": "Name must be between 2 and 80 characters",
    ...
    "game.milestoneStarter": "Starter stack",
    "game.milestoneBuilder": "Builder streak",
    "game.milestoneCapital": "Capital flow",
    "game.milestoneLegend": "Legend vault",
    "game.left": "{value} left",
    "game.backToDashboard": "← Dashboard",
    "game.brandLabel": "MTBank Puzzle",
    "game.score": "Score {value}",
    "game.scoreLabel": "Score",
    "game.pointsLabel": "Pts",
    "game.rewardAvailable": "Reward ×{value}",
    "game.noReward": "No reward",
    "game.noRewardCompact": "No reward live",
    "game.nextGoal": "Next goal: {value}",
    "game.nextMilestone": "Next milestone {value}",
    "game.maxMilestoneReached": "Milestone complete",
    "game.milestoneProgress": "{current} / {target}",
    "game.maxMilestoneComplete": "{label} complete",
  ...
  "ru": {
    ...
    "auth.passwordPlaceholder": "Минимум 8 символов, буквы и цифры",
    "auth.loginCta": "Войти",
    ...
    "auth.nameInvalid": "Имя должно быть длиной от 2 до 80 символов",
    ...
    "game.milestoneStarter": "Стартовый стек",
    "game.milestoneBuilder": "Серия билдера",
    "game.milestoneCapital": "Поток капитала",
    "game.milestoneLegend": "Легендарное хранилище",
    "game.left": "ещё {value}",
    "game.backToDashboard": "← Дашборд",
    "game.brandLabel": "Головоломка MTBank",
    "game.score": "Счёт {value}",
    "game.scoreLabel": "Счёт",
    "game.pointsLabel": "Очки",
    "game.rewardAvailable": "Награда ×{value}",
    "game.noReward": "Нет награды",
    "game.noRewardCompact": "Награды нет",
    "game.nextGoal": "Следующая цель: {value}",
    "game.nextMilestone": "Следующая цель {value}",
    "game.maxMilestoneReached": "Цель закрыта",
    "game.milestoneProgress": "{current} / {target}",
    "game.maxMilestoneComplete": "{label} завершено",
